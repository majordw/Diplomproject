#Da die JSON auf Englisch ist, unser Programm aber auf Deutsch ist, mussten die deutschen Namen der Elemente irgendwo
# hinterlegt werden.
elementeNamenDeutsch = [
    "Wasserstoff","Helium",
    ...
    "Hafnium", "Tantal", "Wolfram", "Rhenium", "Osmium", "Iridium", "Platin", "Gold", "Quecksilber", "Thallium", "Blei", "Bismut" , "Polonium", "Astat", "Radon",
    ...
    "Rutherfordium", "Dubnium", "Seaborgium", "Bohrium" , "Hassium", "Meitnerium", "Darmstadtium", "Roentgenium", "Copernicium", "Nihonium", "Flerovium", "Moscovium", "Livermorium", "Tenness", "Oganesson",
    "Ununennium"
    ]